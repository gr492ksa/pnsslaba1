...
<div class="container mt-4">
    <a class="text-success text-decoration-none" href="subscriber_add"><h5>< Назад</h5></a>
</div>

<h2 class=" mt-5 fw-bold mb-0 d-flex justify-content-center">Добавление абонента</h2>
<h4 class=" mt-5 fw-bold mb-0 d-flex justify-content-center">Подразделение</h4>
    ...
    <div class="col-md-7 col-lg-8">
        <form method="post" class="needs-validation" novalidate="">
            <div class="row g-3 d-flex justify-content-center">
                ...
                <button class="my-5 w-50 btn btn-success btn-lg" type="submit">Далее</button>
