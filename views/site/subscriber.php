...
<h1 class=" mt-5 fw-bold mb-4 d-flex justify-content-center">Абонент</h1>
...
<div class="container d-flex justify-content-center">
    ...
    <div class="col-md-7 col-lg-8">
        <div class="row g-3 d-flex justify-content-center">
            ...
            <h4 class="mt-5 d-flex justify-content-center">Подразделение</h4>
            ...
            <h4 class="mt-5 d-flex justify-content-center">Помещение</h4>
